...
namespace LibroSueldoDigital.Clases
{
    class ClassDatosFijos
    {
        ...
        public string CodigoSiniestrado { get; set; }
        public string CodigoLocalidad { get; set; }
        public string SituacionRevista1 { get; set; }
        public string DiaInicioSituacion1 { get; set; }
        public string SituacionRevista2 { get; set; }
        public string DiaInicioSituacion2 { get; set; }
        public string SituacionRevista3 { get; set; }
        public string DiaInicioSituacion3 { get; set; }
        public string DiasTrabajado { get; set; }
        public string HorasTrabajdo { get; set; }
        public string PorAporteSS { get; set; }
        public string PorTareaDiferencial { get; set; }
        public string CodigoObraSocial { get; set; }
        public string CantidadAherente { get; set; }
        public string AporteAdicOS { get; set; }
        public string ContAdicOS { get; set; }
        public string BaseCalculoAporteOsFsr { get; set; }
