...
{
    partial class FrmAcercaDe : Telerik.WinControls.UI.RadForm
    {
        public FrmAcercaDe()
        {
            InitializeComponent();
            ...
            this.radTextBoxDescription.Text = "Sistema que genera un archivo txt con los datos de una liquidacion de sueldo para ser subido a la pagina del afip";
        }
